...
当前默认采用大物体：单次场景为直径 40 cm 的球、35×35×30 cm 箱体、直径 32 cm / 高 40 cm 圆柱；连续场景 STL 最长边为 35–55 cm。物体质量为 0.4–0.7 kg，近距离 1.0–1.4 m、初速度 4–5 m/s、目标高度 1.0 m，集中从正前方投向机器人，连续抛掷间隔延长到 4–6 s。分层模式在站立奖励上增加持续双掌接触且低速抱持的奖励和成功判据；项目没有训练好的抱持策略。
